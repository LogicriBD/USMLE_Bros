...
const Navbar = () =>{
    ...
    return (
        <nav className="bg-sky-300 p-3 sticky top-0 z-50">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-6 flex justify-center items-center">
                    <div className="text-sky-900 bg-gray-100 hover:bg-gray-300 cursor-pointer font-bold text-md rounded-lg px-4 py-2">Login</div>
