...
const RootPage = () =>
{
    ...
    return (
        <div className="flex flex-col w-full h-full min-h-full justify-center items-center">
            <div className="w-4/5 h-[650px] mx-4 flex flex-row bg-marrow-light text-white border rounded-xl">
                <div className="w-1/2 h-full">
                    <Image src="/images/background.png" alt="USMLE Bros Logo" width={1000} height={1000} className="w-full h-full" />
                </div>
                <div className="w-1/2 flex flex-col justify-center items-center px-4 py-2">
